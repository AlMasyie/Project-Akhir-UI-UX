  ...
  return (
    <>
      ...
      <Modal
        ...
        centered
        dialogClassName="custom-modal18"
      >
        <Modal.Body className="d-flex flex-column p-5">
          ...
          <Form className="d-flex flex-column gap-">
            ...
            <Form className="d-flex flex-column mb-4"></Form>
            <Form.Group controlId="formPortofolioUpload">
              <Form.Label
                style={{
                  fontSize: "20px",
                  fontWeight: "bold",
              ...
              >
                Unggah Portofolio<span style={{ color: "red" }}>*</span>
              </Form.Label>
              <Form.Control type="file" />
            </Form.Group>
            ...
            <Form.Group controlId="formCheckbox" className="mt-4">
              <Form.Check
                type="checkbox"
                label="Saya yakin bahwa dokumen yang saya kirim itu benar, dan siap bertanggung jawab apabila terdapat pemalsuan atau manipulasi"
                style={{
                  fontSize: "16px",
                  fontWeight: "normal",
                  color: "#7e7e7e",
